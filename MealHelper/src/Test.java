...
public class Test {
    public static void main(String[] args) {
        ...
        Food f5 = new Food( "Thoughtbeat" , "Lamb  -  Sausage  Casings" , 552.21 , 1448.35 , 3.31 , 9.06 , 18.95 , 21.31 );
        ...
        Food f8 = new Food( "Edgewire" , "Bread  -  Wheat  Baguette" , 758.41 , 312.07 , 18.66 , 6.48 , 11.99 , 4.16 );
       ...
       List<Nutriment> nutriments2 = new ArrayList<>();
        ...
        System.out.println(a.search(154542.41));
